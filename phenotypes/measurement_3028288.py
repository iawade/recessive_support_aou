...
# 
# <div class='alert alert-info' style='font-family:Arial; font-size:20px' ><center><font size="6"> Lab Measurement(s) 3028288 <br><br><font size=5> Low Density Lipoprotein</font></center></div>
# 
# This notebook details how the data for laboratory measurement(s) 3028288 was curated for All by All analysis. The sections are as follows:
# 
...
pid_summary = pid_level_summary([3028288], df_final)
pid_summary.head()
