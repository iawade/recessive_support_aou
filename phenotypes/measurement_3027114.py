...
# 
# <div class='alert alert-info' style='font-family:Arial; font-size:20px' ><center><font size="6"> Lab Measurement(s) 3027114 <br><br><font size=5> Total Cholesterol</font></center></div>
# 
# This notebook details how the data for laboratory measurement(s) 3027114 was curated for All by All analysis. The sections are as follows:
# 
...
df_harmonized_dropped = drop_ehr_site(df_harmonized, which_sites = [243])
...
pid_summary = pid_level_summary([3027114], df_trimmed_dropped)
pid_summary.head()
